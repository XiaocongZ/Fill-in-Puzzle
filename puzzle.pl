...
test(99):-
    ...
    Puzzle1= [[_,_,_,_,_,_,_,_,'#',_,_,_,_,_,_,_,_,'#',_,_,_,_,_,_,_],[_,'#','#','#',_,'#','#','#','#',_,'#','#','#',_,'#','#','#','#',_,'#',_,'#','#','#',_],[_,'#',_,'#',_,'#',_,_,_,_,_,_,_,_,_,_,'#','#',_,'#',_,'#','#','#',_],[_,_,_,_,_,_,_,'#','#',_,'#','#','#',_,'#',_,'#',_,_,_,_,_,_,_,_],[_,'#',_,'#',_,'#',_,'#','#',_,'#',_,'#',_,'#',_,'#','#',_,'#',_,'#',_,'#',_],[_,'#',_,'#',_,'#',_,'#',_,_,_,_,_,_,'#',_,'#','#','#','#',_,'#',_,'#',_],[_,'#',_,'#',_,'#',_,'#','#','#','#',_,'#',_,_,_,_,_,_,_,_,'#',_],[_,'#',_,'#',_,_,_,_,_,_,'#',_,'#',_,'#',_,'#',_,'#','#',_,'#',_,'#',_],[_,'#',_,'#','#',_,'#','#',_,'#','#',_,'#','#','#',_,'#',_,'#','#','#','#',_,'#',_],[_,_,_,_,_,_,'#','#',_,_,_,_,_,_,'#',_,'#',_,'#',_,_,_,_,_,_],['#','#','#','#','#',_,'#','#',_,'#','#',_,'#',_,'#',_,'#',_,'#',_,'#','#',_,'#',_],[_,_,_,_,_,_,_,'#',_,'#','#',_,'#',_,'#',_,_,_,_,_,_,_,'#','#',_],[_,'#','#','#','#',_,'#','#',_,'#','#','#','#',_,'#','#','#','#','#',_,'#','#','#','#',_],[_,'#',_,'#','#',_,_,_,_,_,_,_,'#',_,_,_,_,_,_,_,_,'#','#','#',_],[_,'#',_,'#','#','#','#','#',_,'#','#','#','#',_,'#','#','#','#',_,'#','#','#','#','#',_],[_,_,_,_,_,_,'#',_,'#',_,_,_,_,_,_,_,'#',_,_,_,_,_,_,_,_],[_,'#',_,'#','#','#','#',_,'#',_,'#','#','#','#','#','#','#','#',_,'#',_,'#','#','#',_],[_,'#',_,'#',_,_,_,_,_,_,_,_,_,'#','#','#',_,'#',_,'#',_],[_,'#',_,'#','#','#','#',_,'#',_,'#','#',_,'#','#','#',_,'#',_,'#',_,_,_,_,_],['#','#',_,'#','#','#','#',_,'#','#',_,_,_,_,_,_,_,'#',_,'#',_,'#','#','#',_],[_,_,_,_,_,_,_,_,_,_,'#','#',_,'#','#','#',_,'#','#','#','#',_,'#','#',_],[_,'#',_,'#','#','#','#',_,'#','#',_,'#','#',_,_,_,_,_,_,_,_,_,'#','#',_],[_,'#','#',_,_,_,_,_,_,_,_,_,'#',_,'#','#',_,'#','#','#','#',_,'#','#',_],[_,'#','#','#','#','#','#',_,'#','#',_,'#','#',_,'#','#',_,'#','#','#','#',_,'#','#',_],[_,_,_,_,_,_,_,_,'#','#',_,_,_,_,_,_,_,_,_,'#',_,_,_,_,_]],
    time(puzzle_solution(Puzzle, WordList)),
    ground(Puzzle),
    write_puzzle(Puzzle).
%-------------------------------------------------------------------------------
...
puzzle_solution(Puzzle, WordList) :-
    ...
    !,
    match(SlotGroups, SortedWordList).
    %fill(Puzzle, Puzzle_transpose, SortedWordList).
match(_, []).
match(SlotGroups, [Word|R]) :-
    length(Word, N),
